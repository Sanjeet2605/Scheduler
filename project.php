...
<body>
    <section>
        ...
        <div style = "margin-left:38%">
                <button class="button button1" type='submit' name='sch'>
                    Click here to get all scheduled interviews
                </button>
                </div>
        </form>
        <form action="n_scheduled.php" method='post'>
        <div style = "margin-left:38%">
                <button class="button button1" type='submit' name='n_sch'>
                    Click here to get all non scheduled interviews
                </button>
                </div>
        </form>
            <form action="Register.php" method ='post'>
                ...
                <button class="button button1" type='submit' name='update'>
                    Click here to upate the list of interviewee
                </button>
                </div>
    </form>
