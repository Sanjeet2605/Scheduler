...
<?php
    ...
    if($end_time<$start_time){
        ?>
        <script>
            alert("Your timing for schedule is incorrect");
            
        </script>
        <html>
            <h1 class="a">Please check the timings of schedules as end time should be greater than start time of interview</h1>
